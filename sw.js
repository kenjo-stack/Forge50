...
const CACHE='forge50-v2.4.0-muscle-guides';
const FILES=['./','./index.html','./style.css','./v2.css','./readability-v21.css','./exercise-guides.css','./exercise-guides.js','./muscle-diagrams.js','./data.js','./js/store.js','./js/timer.js','./js/app.js','./manifest.json','./assets/icon-192.png','./assets/icon-512.png','./assets/muscle-guides/front.webp','./assets/muscle-guides/back.webp'];
